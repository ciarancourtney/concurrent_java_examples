# CA70 Concurrent Programming - Assignment 1
...
The most naive method of performing this in programming is by using 3 nested for loops, which in Big O Notation is O(n^3).
...
This takes of the order of 2700 ± 100ms